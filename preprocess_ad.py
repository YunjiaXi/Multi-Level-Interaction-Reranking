...
def process_data(ad_feature, behavior, raw_sample, user_profile, store_dir, max_hist_len, list_len):
...
if __name__ == '__main__':
    ...
    max_hist_len = 50
    list_len = 30
    ad_feature = os.path.join(data_dir, data_set_name + '/raw_data/ad_feature.csv')
    behavior = os.path.join(data_dir, data_set_name + '/raw_data/behavior_log.csv')
    raw_sample = os.path.join(data_dir, data_set_name + '/raw_data/raw_sample.csv')
    user_profile = os.path.join(data_dir, data_set_name + '/raw_data/user_profile.csv')
    ...
    if not os.path.isfile(processed_dir + 'data.data'):
        process_data(ad_feature, behavior, raw_sample, user_profile, processed_dir, max_hist_len, list_len)
