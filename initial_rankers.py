...
class BaseModel(object):
    def __init__(self, eb_dim, feature_size, itm_spar_fnum, itm_dens_fnum, hist_spar_fnum, hist_dens_fnum,
        ...
        with tf.name_scope('embedding'):
            ...
            # if self.ft_len % 2:
            #     self.target_item = tf.pad(self.target_item, [[0, 0], [0, 1]])
            #     self.user_seq = tf.pad(self.user_seq, [[0, 0], [0, 0], [0, 1]])
            #     self.ft_len += 1
